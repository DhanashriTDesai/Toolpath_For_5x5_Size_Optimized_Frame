...
dldeRed=36; dldeGreen=45; dldeBlue=60; % Non-uniform rate at which motor feed increases
...
[E,E0,nExtr] = GenerateFeedRate(nelem,nLayer,LCell,Linclined,dldeRed,dldeGreen,dldeBlue);

% generate G-code file
WriteToFile(NPh,NPv,NPzigzag,nx,ny,E,E0,nExtr,nLayer);